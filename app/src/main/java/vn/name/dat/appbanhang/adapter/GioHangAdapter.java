...
import vn.name.dat.appbanhang.Interface.IImageClickListenner;
import vn.name.dat.appbanhang.R;
import vn.name.dat.appbanhang.model.EventBus.TinhTongEvent;
import vn.name.dat.appbanhang.model.GioHang;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            item_giohang_tensp = itemView.findViewById(R.id.item_gihang_tensp);
